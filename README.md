...
1. #2 [n8n-io/n8n](https://github.com/n8n-io/n8n) - Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom code, self-host or cloud, 400+ integrations. (★177316 | last push 2026-03-03). Works best with: [ToolJet/ToolJet](https://github.com/ToolJet/ToolJet), [mudler/LocalAI](https://github.com/mudler/LocalAI).
...
1. #3 [ollama/ollama](https://github.com/ollama/ollama) - Get up and running with Kimi-K2.5, GLM-5, MiniMax, DeepSeek, gpt-oss, Qwen, Gemma and other models. (★163924 | last push 2026-03-03). Works best with: [Mintplex-Labs/anything-llm](https://github.com/Mintplex-Labs/anything-llm), [langgenius/dify](https://github.com/langgenius/dify).
